...
namespace nkentseu {
    VulkanVertexArray::VulkanVertexArray(Memory::Shared<Context> context, Memory::Shared<ShaderInputLayout> sil) : m_Context(Memory::Cast<VulkanContext>(context)) {
    ...
    bool VulkanVertexArray::Draw(RenderPrimitive::Enum primitive) {
