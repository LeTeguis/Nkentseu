...
#include "NTSCore/System.h" // Assuming System.h provides necessary includes
#include <NTSUnitest/UnitestState.h> // Assuming UnitestState.h defines the UnitestState enum
#include <unordered_map> // For std::unordered_map
#include "NTSUnitest/UnitestEntry.h" // Assuming UnitestEntry.h defines the UnitestEntry class
