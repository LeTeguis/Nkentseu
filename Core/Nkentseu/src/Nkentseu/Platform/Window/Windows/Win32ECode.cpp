...
namespace nkentseu {
    ...
    uint64 Win32ECode::ConvertKeycodeWinkey(uint64 code, bool keycode_to_vkey) {
    ...
    Keyboard::Code Win32ECode::WinkeyToKeycodeSpecial(uint64 winkeycode, bool shifDown)
    {
        Keyboard::Code keycode = Win32ECode::ConvertKeycodeWinkey(winkeycode);
    ...
    uint64 Win32ECode::ConvertScancodeWinkey(Keyboard::Code code, bool scancode_to_vkey)
    {
    ...
    Keyboard::Code Win32ECode::WinkeyToScancodeSpecial(uint64 winkeycode, bool shifDown)
    {
        Keyboard::Code scancode = Win32ECode::ConvertScancodeWinkey(winkeycode);
    ...
    ModifierState Win32ECode::ModifierStateToWinkey()
    {
