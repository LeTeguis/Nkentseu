...
namespace nkentseu {
    ...
    LoggerInfos::LoggerInfos() : m_Name("Log"), m_Severity(Severity::Enum::Default), m_File(""), m_Function(), m_Line(0), m_Header(""), m_Message("") {}

    LoggerInfos::LoggerInfos(Severity severity, const std::string& name, const std::string& file,
    ...
    LoggerInfos::LoggerInfos(const std::string& file, const std::string& function, uint32 line, Severity severity,
    ...
    Severity LoggerInfos::GetSeverity() const { return m_Severity; }
    ...
    void LoggerInfos::SetSeverity(Severity severity) { m_Severity = severity; }
