...
def InstallCompilateur():
    ...
    lib_install = ["vulkan-validationlayers", "libx11-dev", "xorg-dev", "libxcb1", "libxcb1-dev", "libxcb-util-dev", "libxcb-icccm4-dev", "libxcb-xkb-dev", "x11-xkb-utils", "libx11-xcb-dev", "libxkbcommon-x11-dev"]
