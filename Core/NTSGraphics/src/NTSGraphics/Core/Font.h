//
// Created by TEUGUIA TADJUIDJE Rodolf Séderis on 2024-07-27 at 09:07:26 AM AM.
...
namespace nkentseu {
    ...
    private:
        ...
        std::unordered_map<uint32, GlyphNG*> glyphCache;
    ...
    private:
        ...
        std::unordered_map<uint32, Memory::Shared<GlyphPages>> m_GlyphPages; // Map from character size to GlyphPages
