...
namespace nkentseu {
    ...
    public:
        ...
        EVENT_CATEGORY_FLAGS(EventCategory::Window) 
    public:
        WindowRenderedEvent(uint64 win, maths::Rectangle rectangle, maths::Color color);
        WindowRenderedEvent(const WindowRenderedEvent& e);
        virtual std::string ToString() const override;  
        
        maths::Rectangle GetRenderRec() const;
        maths::Color GetRenderColor() const;
    private:
    ...
    public:
        ...
        EVENT_CATEGORY_FLAGS(EventCategory::Window)
    public:
        WindowBackgroundErasedEvent(uint64 win, maths::Rectangle rectangle, maths::Color color);
        WindowBackgroundErasedEvent(const WindowBackgroundErasedEvent& e);
        virtual std::string ToString() const override;

        maths::Rectangle GetBackgroundRec() const;
        maths::Color GetBackgroundColor() const;
    private:
        maths::Rectangle m_Rectangle;
        maths::Color m_Color;
    };
