...
namespace nkentseu {
    ...
    public:
         ...
         */
        Formatter(StyleGuide styleGuide, SymbolStyle symbolStyle);
         ...
         */
        void Initialize(StyleGuide styleGuide, SymbolStyle symbolStyle);
