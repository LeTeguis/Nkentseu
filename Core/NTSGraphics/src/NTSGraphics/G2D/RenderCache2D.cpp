...
#define USE_TEXT (1 << 3)*/
    ...
    RenderCommand2D* RenderCache2D::AddText(Memory::Shared<FontNG> font, const std::string& texte, const maths::Vector2f& position, uint32 characteSize, bool bold, bool italic, bool underline, bool strikeThrough, const maths::Color& color, Memory::Shared<Texture2D> texture, const std::vector<maths::Vector2f>& uvs) {
        if (!font || texte.empty()) {
    ...
    /*RenderCommand2D* RenderCache2D::AddText(const TextShape& textShape)
    {
