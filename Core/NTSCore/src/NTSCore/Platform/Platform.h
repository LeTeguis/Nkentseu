...
#define NKENTSEU_VERSION_MINOR      0
	...
	#define NKENTSEU_PLATFORM_UNIX
		...
		#ifdef NKENTSEU_LINUX_USE_WSL
		#define NKENTSEU_PLATFORM_LINUX_USE_SUBSYSTEM
		#elif defined(NKENTSEU_LINUX_UNUSE_WSL)
		#define NKENTSEU_PLATFORM_LINUX_UNUSE_SUBSYSTEM
		#endif
