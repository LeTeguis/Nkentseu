//
// Created by TEUGUIA TADJUIDJE Rodolf Séderis on 2024-07-27 at 09:07:12 AM AM.
...
namespace nkentseu {
    ...
    public:
        maths::Vector2f     sbDelta;                ///< Offset horizontal et vertical après autohint
        maths::Vector2f     bearing;                ///< bearing
        maths::Vector2f     advance;                ///< Offset pour se déplacer horizontalement et verticalement au prochain caractère
        maths::FloatRect    bounds;                 ///< Rectangle englobant le glyphe, en coordonnées relatives à la ligne de base
        maths::IntRect      textureRect;            ///< Coordonnées de la texture du glyphe à l'intérieur de la texture de la police
    ...
    public:
        ...
        Texture2DShared     texture;                ///< Texture associée à la page
        maths::Vector2i     nextPositionWrite;      ///< Position suivante où sera dessiné le prochain glyphe dans la texture
    ...
    public:
        ...
        std::unordered_map<uint64, Glyph>       glyphs;                 ///< Tableau de glyphes indexé par caractère Unicode
